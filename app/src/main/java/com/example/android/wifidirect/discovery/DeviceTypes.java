...
/**
 * Created by anitaimani on 02/03/16.
 */
public class DeviceTypes {
    ...
    public static String getDeviceTypes(Context activity, Device device) {
            try {
                switch (device) {
...
//                            }
        ...
        public static boolean isWatch(Context context){
            return (context.getResources().getConfiguration().screenLayout & Configuration.SCREENLAYOUT_LONG_MASK ) <= Configuration.SCREENLAYOUT_SIZE_SMALL;
        }
